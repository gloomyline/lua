...
function scene:create( event )
	...
	local playBtn = display.newText(sceneGroup, 'Play', display.contentCenterX, 700, native.systemFont, 40)
	playBtn:setFillColor(0.82, 0.86, 1)

	local highScoresBtn = display.newText(sceneGroup, 'HighScores', display.contentCenterX, 810, native.systemFont, 40)
